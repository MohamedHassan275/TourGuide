...
public class TaipeiActivity  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atractions.add(new Atraction(getResources().getString(R.string.taipei_attraction_name_1), getResources().getString(R.string.taipei_attraction_phone_1), getResources().getString(R.string.taipei_attraction_address_1), getResources().getString(R.string.taipei_attraction_imageurl_1), elephantMountain));
        ...
        atractions.add(new Atraction(getResources().getString(R.string.taipei_attraction_name_2), getResources().getString(R.string.taipei_attraction_phone_2), getResources().getString(R.string.taipei_attraction_address_2), getResources().getString(R.string.taipei_attraction_imageurl_2), longshanTemple));
        ...
        atractions.add(new Atraction(getResources().getString(R.string.taipei_attraction_name_3), getResources().getString(R.string.taipei_attraction_phone_3), getResources().getString(R.string.taipei_attraction_address_3), getResources().getString(R.string.taipei_attraction_imageurl_3), maokongGondola));
        ...
        atractions.add(new Atraction(getResources().getString(R.string.taipei_attraction_name_4), getResources().getString(R.string.taipei_attraction_phone_4), getResources().getString(R.string.taipei_attraction_address_4), getResources().getString(R.string.taipei_attraction_imageurl_4), chiangKaiShekMemorialHall));
        ...
        atractions.add(new Atraction(getResources().getString(R.string.taipei_attraction_name_5),
