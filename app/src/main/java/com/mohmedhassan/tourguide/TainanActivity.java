...
public class TainanActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        atractions.add(new Atraction(getResources().getString(R.string.tainan_attraction_name_1),
        ...
        atractions.add(new Atraction(getResources().getString(R.string.tainan_attraction_name_2),
        ...
        atractions.add(new Atraction(getResources().getString(R.string.tainan_attraction_name_3),
        ...
        atractions.add(new Atraction(getResources().getString(R.string.tainan_attraction_name_4),
        ...
        atractions.add(new Atraction(getResources().getString(R.string.tainan_attraction_name_5),
